...
let listProviderMothAvailabilityService: ListProviderMothAvailabilityService;
...
describe('ListProviderMothAvailability', () => {
  beforeEach(() => {
    ...
    listProviderMothAvailabilityService = new ListProviderMothAvailabilityService(
